...
--
-- Servidor: mysql:3306
-- Tiempo de generación: 18-02-2026 a las 00:27:44
...
VALUES
  (1, '2025-12-10 13:05:52', 'Desparasitacion', 1),
  (2, '2025-12-10 13:05:52', 'Revisión anual', 2),
  (3, '2025-12-10 13:05:52', 'Vacunación', 3);
...
--
INSERT INTO
  `roles` (`id_role`, `nombre`, `descripcion`, `created_at`)
VALUES
  (
    1,
    'user',
...
VALUES
  (
    1,
    'admin@test.com',
    '$2b$10$zWfg5QO.sBntTu8LMOe1oOqQRH9Ug2S2eqIIhDrwPn7FcFry9/kNO',
    1,
    '2026-01-28 13:34:56'
  ),
  (
  ...
  (
    7,
    'nuevo3@test.com',
    '$2b$10$0alTrQaWqN3odpsDdSpTkOuLOt/i9YL/KlvMprnpU2BApyN1xDNYy',
    1,
    '2026-02-06 14:19:32'
  ),
  (
    8,
    'nuevo4@test.com',
    '$2b$10$KlsEU949Z8jQtkFH1hgrUOR4mvFLQqgUjq24NOnq7UT2JN4Cv7H66',
    1,
    '2026-02-11 20:50:35'
  );
...
ADD
  KEY `fk_user_roles_role` (`id_role`);
...
ALTER TABLE
  `historiales_clinicos`
ADD
  CONSTRAINT `historiales_clinicos_ibfk_1` FOREIGN KEY (`id_mascota`) REFERENCES `mascotas` (`id_mascota`);
...
ALTER TABLE
  `mascotas`
ADD
  CONSTRAINT `mascotas_ibfk_1` FOREIGN KEY (`id_dueno`) REFERENCES `duenos` (`id_dueno`);
...
ALTER TABLE
  `user_roles`
ADD
  CONSTRAINT `fk_user_roles_role` FOREIGN KEY (`id_role`) REFERENCES `roles` (`id_role`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD
  CONSTRAINT `fk_user_roles_user` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
